...
export default function Header({ shop }) {
  ...
  return (
    <>
      ...
      <header
        role="banner"
        className={`flex items-center h-16 p-6 md:p-8 lg:p-12 sticky backdrop-blur-sm z-40 top-0 justify-between w-full leading-none gap-4 antialiased transition shadow-sm ${
